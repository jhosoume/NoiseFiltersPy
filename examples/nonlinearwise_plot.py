...
from NoiseFiltersPy.NonlinearwiseInjector import NonlinearwiseInjector
...
injector = NonlinearwiseInjector(artificial_dataset.iloc[:, :2].values, artificial_dataset.Class.values, rate = 0.3)
injector.generate()
...
plt.tight_layout()
plt.savefig("examples/nonlinearwise_artificial.png")